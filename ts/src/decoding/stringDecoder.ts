...
export const ROOT_COLUMN_NAME = "default";
export const NESTED_COLUMN_SEPARATOR = ":";

export function decodeStringVector(
    name: string,
    data: Uint8Array,
    offset: IntWrapper,
    numStreams: number,
    ...
    return decodeFsstDictionaryStringVector(
        name,
        symbolTableStream,
        offsetStream,
    ...
    ) ?? decodeDictionaryStringVector(
        name,
        dictionaryStream,
        offsetStream,
        dictionaryLengthStream,
        bitVector ?? presentStream
    ) ?? decodePlainStringVector(
        name,
        plainLengthStream,
        plainDataStream,
        offsetStream,
...
export function decodeFsstDictionaryStringVector(
    name: string,
...
export function decodeDictionaryStringVector(
    name: string,
    dictionaryStream: Uint8Array | null,
    offsetStream: Int32Array | null,
    dictionaryLengthStream: Int32Array | null,
...
export function decodePlainStringVector(
    name: string,
...
export function decodeSharedDictionary(
    ...
    for (const childField of childFields) {
        ...
        const columnName = `${column.name}${
            childField.name === ROOT_COLUMN_NAME
                ? ""
                : NESTED_COLUMN_SEPARATOR + childField.name
        }`;
