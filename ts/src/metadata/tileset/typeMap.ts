 ...
 */
export function decodeColumnTypeFromCode(typeCode: number): Column | null {
    switch (typeCode) {
        case 0:
        case 1:
        case 2:
        ...
        default:
            return mapScalarTypeCodeToColumn(typeCode);
    }
}
 ...
 */
export function doesColumnTypeHaveExplicitName(typeCode: number): boolean {
    return typeCode >= 10;
}
 ...
 */
export function doesColumnTypeHaveChildren(typeCode: number): boolean {
    return typeCode === 30;
}
 ...
 */
export function doesColumnHaveStreamCount(column: Column): boolean {
 ...
 */
export function mapScalarTypeCodeToColumn(typeCode: number): Column | null {
